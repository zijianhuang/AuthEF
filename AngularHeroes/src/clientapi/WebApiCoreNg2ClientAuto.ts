...
export namespace Fonlow_Auth_Models_Client {
	 ...
	 * Section 5.1
	 */
	export interface AccessTokenResponseFormProperties extends Fonlow_Auth_Models_Client.TokenResponseBaseFormProperties {
	...
	export function CreateAccessTokenResponseFormGroup() {
		return new FormGroup<AccessTokenResponseFormProperties>({
			...
			expires_in: new FormControl<number | null | undefined>(undefined, [Validators.required, Validators.min(-2147483648), Validators.max(2147483647)]),
	 ...
	 * Grant type MUST be set to "refresh_token".
	 */
	export interface RefreshAccessTokenRequestFormProperties extends Fonlow_Auth_Models_Client.RequestBaseFormProperties {
	...
	export interface RequestBaseFormProperties {

		/** Required */
		grant_type: FormControl<string | null | undefined>,
	}
	export function CreateRequestBaseFormGroup() {
		return new FormGroup<RequestBaseFormProperties>({
			grant_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	 ...
	 * GrantType must be Value MUST be set to "password".
	 */
	export interface ROPCRequstFormProperties extends Fonlow_Auth_Models_Client.RequestBaseFormProperties {
	...
	export function CreateROPCRequstFormGroup() {
		return new FormGroup<ROPCRequstFormProperties>({
			grant_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface TokenResponseBaseFormProperties {
	...
	export function CreateTokenResponseBaseFormGroup() {
		return new FormGroup<TokenResponseBaseFormProperties>({
			token_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
