...
dotnet publish ../Fonlow.EntityFrameworkCore.MsSql/Fonlow.EntityFrameworkCore.MsSql.csproj -r $RuntimeId --configuration Release --output bin/Release/$netVersion
...
Invoke-Expression "&./bin/Release/$netVersion/$CreatorExe Fonlow.EntityFrameworkCore.MsSql '$connectionString'"